//"use strict"
let pars = ["function agetodays(age)\n { var ageintodays = age * 365 ;\n return ageintodays; }\n console.log(agetodays(prompt('enter your age')));"
,"function calcprice(price , taxes){ \n   let total = price * taxes ; \n   return total;}\n let real_price = calcprice(20,10) ;\n console.log( real_price+ '$') ; function calcEGY(price) {    let egy = price*50;    return egy;} let Egy_price = calcEGY(real_price);console.log(Egy_price + ' جنيه'  );"
